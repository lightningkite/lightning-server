...
class TypedDataGetRangeTest {
    ...
    @Test
    fun bounded_on_bytes_slices_inclusive() {
    ...
    @Test
    fun until_end_on_bytes_returns_tail() {
    ...
    @Test
    fun bounded_on_text_slices_underlying_bytes() {
    ...
    @Test
    fun bounded_on_source_slices_inclusive() {
    ...
    @Test
    fun until_end_on_source_returns_tail() {
    ...
    @Test
    fun until_end_on_sink_returns_tail() {
    ...
    @Test
    fun single_byte_bounded_on_bytes() {
    ...
    @Test
    fun until_end_from_zero_returns_full_payload_for_source() {

...
public class ModificationChain<T : Codable & Hashable> : Modification<T>, CustomStringConvertible {
...
public class ModificationIfNotNull<T : Codable & Hashable> : Modification<T?>, CustomStringConvertible {
    ...
    override public func invoke(on: T?) -> T? {
        return on.flatMap { temp36 in ({ (it) -> T in self.modification.invoke(on: it) })(temp36) };
    }
    override public func invokeDefault() -> T? {
        return nil;
    }
}
public class ModificationAssign<T : Codable & Hashable> : Modification<T>, CustomStringConvertible {
    public var value: T
...
public class ModificationCoerceAtMost<T : Codable & Hashable & Comparable> : Modification<T>, CustomStringConvertible {
    public var value: T
    public init(_ value: T) {
        self.value = value
        super.init()
...
public class ModificationCoerceAtLeast<T : Codable & Hashable & Comparable> : Modification<T>, CustomStringConvertible {
    public var value: T
    public init(_ value: T) {
        self.value = value
        super.init()
...
public class ModificationIncrement<T : Number> : Modification<T>, CustomStringConvertible {
    public var by: T
    public init(by: T) {
        self.by = by
        super.init()
...
public class ModificationMultiply<T : Number> : Modification<T>, CustomStringConvertible {
    public var by: T
    public init(by: T) {
        self.by = by
        super.init()
...
public class ModificationAppendString : Modification<String>, CustomStringConvertible {
...
public class ModificationAppendList<T : Codable & Hashable> : Modification<Array<T>>, CustomStringConvertible {
...
public class ModificationAppendSet<T : Codable & Hashable> : Modification<Array<T>>, CustomStringConvertible {
    public var items: Array<T>
    public init(items: Array<T>) {
        self.items = items
        super.init()
...
public class ModificationRemove<T : Codable & Hashable> : Modification<Array<T>>, CustomStringConvertible {
...
public class ModificationRemoveInstances<T : Codable & Hashable> : Modification<Array<T>>, CustomStringConvertible {
    public var items: Array<T>
    public init(items: Array<T>) {
        self.items = items
        super.init()
...
public class ModificationDropFirst<T : Codable & Hashable> : Modification<Array<T>> {
...
public class ModificationDropLast<T : Codable & Hashable> : Modification<Array<T>> {
    override public init() {
        super.init()
        //Necessary properties should be initialized now
    }
...
public class ModificationPerElement<T : Codable & Hashable> : Modification<Array<T>>, CustomStringConvertible, Codable {
    public var condition: Condition<T>
    public var modification: Modification<T>
...
public class ModificationCombine<T : Codable & Hashable> : Modification<Dictionary<String, T>>, CustomStringConvertible {
...
public class ModificationModifyByKey<T : Codable & Hashable> : Modification<Dictionary<String, T>>, CustomStringConvertible {
...
public class ModificationRemoveKeys<T : Codable & Hashable> : Modification<Dictionary<String, T>>, CustomStringConvertible {
...
public class ModificationOnField<K : Codable & Hashable, V : Codable & Hashable> : Modification<K>, CustomStringConvertible {
    public var key: DataClassProperty<K, V>
    public var modification: Modification<V>
    public init(key: DataClassProperty<K, V>, modification: Modification<V>) {
        self.key = key
        self.modification = modification
        super.init()
        //Necessary properties should be initialized now
    ...
    public func copy(key: DataClassProperty<K, V>? = nil, modification: Modification<V>? = nil) -> ModificationOnField<K, V> { return ModificationOnField(key: key ?? self.key, modification: modification ?? self.modification) }
    
    override public func invoke(on: K) -> K {
        return self.key.set(on: on, value: self.modification.invoke(on: self.key.get(on: on)));
    }

...
This package contains the cross-platform (multiplatform) definitions used by both server and client code for typed API communication.
...
These types are used by generated client SDKs to provide type-safe API access. Server developers typically don't interact with these directly, but they define the contract between server and client.

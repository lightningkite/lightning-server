...
class EmailAuthTest {
    ...
    fun testPinCorrect() {
        runBlocking {
            TestSettings.emailAuth.loginEmail.implementation(AuthAndPathParts(null, arrayOf()), "joseph@lightningkite.com")
            ...
            val token = TestSettings.emailAuth.loginEmailPin.implementation(AuthAndPathParts(null, arrayOf()), EmailPinLogin("joseph@lightningkite.com", pin))
            assertEquals(
    ...
    fun testPinIncorrect() {
        runBlocking {
            ...
            val pin = "wrong"
            try {
                TestSettings.emailAuth.loginEmailPin.implementation(AuthAndPathParts(null, arrayOf()), EmailPinLogin("joseph@lightningkite.com", pin))
                fail()

...
internal fun MutableMap<String, JsonElement>.merge(key: String, element: JsonElement): JsonElement? {
    return remapMerge(key, element, ::merge)
}

internal fun merge(previous: JsonElement, value: JsonElement): JsonElement? {
    return when {
...
internal fun merge(previous: JsonObject, value: JsonObject): JsonObject? {

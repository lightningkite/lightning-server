...
The notification system supports four delivery channels: email, SMS, push notifications, and in-app. Each can be
scheduled independently with different frequencies.

    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // The event taxonomy belongs to the module that raises the events, not to the one
                // that records them. One-directional: auth-shared knows nothing about auditing.

...
import com.lightningkite.lightningserver.auth.authEventReporters
...
): Unit = reportProofEvent(AuthEventType.ProofRejected, method, principal, request, reason.name)
...
public suspend fun reportProofAccepted(
    ...
    principal: String? = null,
    request: Request<*>? = null,
): Unit = reportProofEvent(AuthEventType.ProofAccepted, method, principal, request, null)
...
public suspend fun reportProofIssued(
    ...
    principal: String? = null,
    request: Request<*>? = null,
): Unit = reportProofEvent(AuthEventType.ProofIssued, method, principal, request, null)

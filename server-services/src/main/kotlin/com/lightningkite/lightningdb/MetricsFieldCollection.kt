...
class MetricsFieldCollection<M: Any>(override val wraps: FieldCollection<M>, val metrics: Metrics, metricsKeyName: String = "Database"): FieldCollection<M> {
...
fun <Model : Any> FieldCollection<Model>.metrics(metrics: Metrics, metricsKeyName: String): FieldCollection<Model> =
    MetricsFieldCollection(this, metrics, metricsKeyName)

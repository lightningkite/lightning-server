...
export declare type AnnotateEndpointReturn<T extends HasId, Annotation> = Pick<RestEndpoint<WithAnnotations<T, Annotation>>, ReadonlyEndpointKeys>;
export declare type ReadonlySessionRestEndpoint<T extends HasId> = Pick<RestEndpoint<T>, ReadonlyEndpointKeys>;
/**
 ...
 */
export declare function annotateEndpoint<T extends HasId, Annotation>(endpoint: RestEndpoint<T>, addAnnotations: (originalItems: T[]) => Promise<WithAnnotations<T, Annotation>[]>): AnnotateEndpointReturn<T, Annotation>;

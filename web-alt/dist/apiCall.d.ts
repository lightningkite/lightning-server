...
export declare function apiCall<T>(url: string, body: T, request: RequestInit, fileUploads?: Record<Path<T>, File>, errorHandlers?: Array<(x: Response) => void>): Promise<Response>;
export {};

...
This package provides image processing capabilities for Lightning Server, including automatic preview generation, format conversion, and optimization.
...
### Preview Selection
The `ServerFileWithMetadata.previews()` method sorts previews by best fit for requested dimensions, preferring previews that meet or exceed requirements.

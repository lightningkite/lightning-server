...
internal suspend fun DynamoDbAsyncClient.requireTable(createTableRequest: (CreateTableRequest.Builder) -> Unit, timeToLive: (UpdateTimeToLiveRequest.Builder) -> Unit) {

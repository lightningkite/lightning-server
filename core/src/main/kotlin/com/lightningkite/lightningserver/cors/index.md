...
This package provides Cross-Origin Resource Sharing (CORS) support for Lightning Server applications. CORS is a browser
security mechanism that controls which web applications can make cross-origin requests to your API.

...
- UploadInformation is returned to clients when initiating an early upload; it contains the presigned PUT URL and a
  token that can be sent later as a ServerFile in an API call.

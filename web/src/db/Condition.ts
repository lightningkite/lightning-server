...
export namespace Condition {
    ...
    export class ListAllElements<E extends any> extends Condition<Array<E>> {
        ...
        public static propertyTypes(E: ReifiedType) {
    ...
    setUpDataClass(ListAllElements)
}
export namespace Condition {
    //! Declares com.lightningkite.lightningdb.Condition.ListAnyElements
    export class ListAnyElements<E extends any> extends Condition<Array<E>> {
        public constructor(public readonly condition: Condition<E>) {
            super();
        }
    ...
    setUpDataClass(ListAnyElements)
}
export namespace Condition {
    //! Declares com.lightningkite.lightningdb.Condition.ListSizesEquals
    export class ListSizesEquals<E extends any> extends Condition<Array<E>> {
    ...
    setUpDataClass(ListSizesEquals)
}
export namespace Condition {
    //! Declares com.lightningkite.lightningdb.Condition.SetAllElements
    export class SetAllElements<E extends any> extends Condition<Set<E>> {
        public constructor(public readonly condition: Condition<E>) {
            super();
        }
        ...
        public invoke(on: Set<E>): boolean {
            return every((it: E): boolean => (this.condition.invoke(it)), on);
        }
    }

    setUpDataClass(SetAllElements)
}
export namespace Condition {
    //! Declares com.lightningkite.lightningdb.Condition.SetAnyElements
    export class SetAnyElements<E extends any> extends Condition<Set<E>> {
        public constructor(public readonly condition: Condition<E>) {
            super();
        }
        ...
        public invoke(on: Set<E>): boolean {
            return some((it: E): boolean => (this.condition.invoke(it)), on);
        }
    }

    setUpDataClass(SetAnyElements)
}
export namespace Condition {
    //! Declares com.lightningkite.lightningdb.Condition.SetSizesEquals
    export class SetSizesEquals<E extends any> extends Condition<Set<E>> {
        public constructor(public readonly count: number) {
            super();
        }
...
export namespace Condition {
    ...
    export class Exists<V extends any> extends Condition<Map<string, V>> {
        ...
        public static propertyTypes(V: ReifiedType) {
            return {key: [String]}
        }
...
export namespace Condition {
    ...
    export class OnField<K extends any, V extends any> extends Condition<K> {
        ...
        public static propertyTypes(K: ReifiedType, V: ReifiedType) {

...
import { KeyPath, startChain } from './dsl'
...
export class Query<T extends any> {
    ...
    public static constructorListcomSortPartcomQueryTIntIntFunction1comKeyPathcomQueryTQueryTConditioncomQueryT<T extends any>(
        orderBy: Array<SortPart<T>> = [],
        skip: number = 0,
        limit: number = 100,
        makeCondition: ((a: KeyPath<T, T>) => Condition<T>),
    ) {

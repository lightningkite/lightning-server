...
export class PropChain<From extends any, To extends any> {
    ...
    public get<V extends any>(prop: KProperty1<To, V>): PropChain<From, V> {
...
//! Declares com.lightningkite.lightningdb.fullTextSearch>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.fullTextSearch.K, com.lightningkite.lightningdb.fullTextSearch.K
export function xPropChainFullTextSearch<K extends any>(this_: PropChain<K, K>, value: string, ignoreCase: boolean): Condition<K> {
    return this_.mapCondition(new Condition.FullTextSearch<K>(value, ignoreCase));
}

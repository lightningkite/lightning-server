...
import {first, map as iMap, toArray} from 'iter-tools-es'
...
export class PropChain<From extends any, To extends any> {
    ...
    public chain<V extends any>(other: PropChain<To, V>): PropChain<From, V> {
        return new PropChain<From, V>((it: Condition<V>): Condition<From> => (this.mapCondition(other.mapCondition(it))), (it: Modification<V>): Modification<From> => (this.mapModification(other.mapModification(it))), (it: From): V => (other.getProp(this.getProp(it))), (from: From, to: V): From => (this.setProp(from, other.setProp(this.getProp(from), to))));
    }
...
export function xPropChainAlwaysGet<K extends any>(this_: PropChain<K, K>): Condition<K> {
    return new Condition.Always<K>();
}
...
export function xPropChainNeverGet<K extends any>(this_: PropChain<K, K>): Condition<K> {
    return new Condition.Never<K>();
}
...
export function xPropChainInsideSet<K extends any, T extends any>(this_: PropChain<K, T>, values: Set<T>): Condition<K> {
...
export function xPropChainNinSet<K extends any, T extends any>(this_: PropChain<K, T>, values: Set<T>): Condition<K> {
...
export function xPropChainNotInSet<K extends any, T extends any>(this_: PropChain<K, T>, values: Set<T>): Condition<K> {
    return this_.mapCondition(new Condition.NotInside<T>(toArray(values)));
}
...
export function xPropChainNotNullGet<K extends any, T extends any>(this_: PropChain<K, (T | null)>): PropChain<K, T> {
    return new PropChain<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.IfNotNull<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.IfNotNull<T>(it))), (it: K): T => (this_.getProp(it)!!), (it: K, value: T): K => (this_.setProp(it, value)));
}
...
//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.all.K, kotlin.collections.Listcom.lightningkite.lightningdb.all.T
export function xPropChainListAllGet<K extends any, T extends any>(this_: PropChain<K, Array<T>>): PropChain<K, T> {
    return new PropChain<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.ListAllElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.ListPerElement<T>(new Condition.Always<T>(), it))), (it: K): T => (first(this_.getProp(it))!), (from: K, to: T): K => (this_.setProp(from, this_.getProp(from).concat([to]))));
}


//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.all.K, kotlin.collections.Setcom.lightningkite.lightningdb.all.T
export function xPropChainSetAllGet<K extends any, T extends any>(this_: PropChain<K, Set<T>>): PropChain<K, T> {
    return new PropChain<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.SetAllElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.SetPerElement<T>(new Condition.Always<T>(), it))), (it: K): T => (first(this_.getProp(it))!), (from: K, to: T): K => (this_.setProp(from, new EqualOverrideSet([...this_.getProp(from), to]))));
}


//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.any.K, kotlin.collections.Listcom.lightningkite.lightningdb.any.T
export function xPropChainListAnyGet<K extends any, T extends any>(this_: PropChain<K, Array<T>>): PropChain<K, T> {
    return new PropChain<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.ListAnyElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.ListPerElement<T>(new Condition.Always<T>(), it))), (it: K): T => (first(this_.getProp(it))!), (from: K, to: T): K => (this_.setProp(from, this_.getProp(from).concat([to]))));
}


//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.any.K, kotlin.collections.Setcom.lightningkite.lightningdb.any.T
export function xPropChainSetAnyGet<K extends any, T extends any>(this_: PropChain<K, Set<T>>): PropChain<K, T> {
    return new PropChain<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.SetAnyElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.SetPerElement<T>(new Condition.Always<T>(), it))), (it: K): T => (first(this_.getProp(it))!), (from: K, to: T): K => (this_.setProp(from, new EqualOverrideSet([...this_.getProp(from), to]))));
}

...
export class CMBuilder<From extends any, To extends any> {
...
export function xDataClassPathToCMBuilder<From extends any, To extends any>(this_: DataClassPath<From, To>): CMBuilder<From, To> {
    return new CMBuilder<From, To>((it: Condition<To>): Condition<From> => (this_.mapCondition(it)), (it: Modification<To>): Modification<From> => (this_.mapModification(it)));
}
...
export function xCMBuilderAlwaysGet<K extends any>(this_: CMBuilder<K, K>): Condition<K> { return new Condition.Always<K>(); }
...
export function xCMBuilderNeverGet<K extends any>(this_: CMBuilder<K, K>): Condition<K> { return new Condition.Never<K>(); }
...
export function xCMBuilderEq<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.Equal<T>(value));
}
...
export function xCMBuilderNeq<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.NotEqual<T>(value));
}
...
export function xCMBuilderNe<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.NotEqual<T>(value));
}
...
export function xCMBuilderInsideSet<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Set<T>): Condition<K> {
    return this_.mapCondition(new Condition.Inside<T>(toArray(values)));
}
//! Declares com.lightningkite.lightningdb.inside>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.inside.K, com.lightningkite.lightningdb.inside.T
export function xCMBuilderInside<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Array<T>): Condition<K> {
    return this_.mapCondition(new Condition.Inside<T>(values));
}
...
export function xCMBuilderNinSet<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Set<T>): Condition<K> {
    return this_.mapCondition(new Condition.NotInside<T>(toArray(values)));
}
//! Declares com.lightningkite.lightningdb.nin>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.nin.K, com.lightningkite.lightningdb.nin.T
export function xCMBuilderNin<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Array<T>): Condition<K> {
    return this_.mapCondition(new Condition.NotInside<T>(values));
}
...
export function xCMBuilderNotInSet<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Set<T>): Condition<K> {
    return this_.mapCondition(new Condition.NotInside<T>(toArray(values)));
}
//! Declares com.lightningkite.lightningdb.notIn>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.notIn.K, com.lightningkite.lightningdb.notIn.T
export function xCMBuilderNotIn<K extends any, T extends any>(this_: CMBuilder<K, T>, values: Array<T>): Condition<K> {
    return this_.mapCondition(new Condition.NotInside<T>(values));
}
...
export function xCMBuilderGt<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.GreaterThan<T>(value));
}
...
export function xCMBuilderLt<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.LessThan<T>(value));
}
...
export function xCMBuilderGte<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.GreaterThanOrEqual<T>(value));
}
...
export function xCMBuilderLte<K extends any, T extends any>(this_: CMBuilder<K, T>, value: T): Condition<K> {
    return this_.mapCondition(new Condition.LessThanOrEqual<T>(value));
}
...
export function xCMBuilderAllClear<K extends any>(this_: CMBuilder<K, number>, mask: number): Condition<K> {
    return this_.mapCondition(new Condition.IntBitsClear(mask));
}
...
export function xCMBuilderAllSet<K extends any>(this_: CMBuilder<K, number>, mask: number): Condition<K> {
    return this_.mapCondition(new Condition.IntBitsSet(mask));
}
...
export function xCMBuilderAnyClear<K extends any>(this_: CMBuilder<K, number>, mask: number): Condition<K> {
    return this_.mapCondition(new Condition.IntBitsAnyClear(mask));
}
...
export function xCMBuilderAnySet<K extends any>(this_: CMBuilder<K, number>, mask: number): Condition<K> {
    return this_.mapCondition(new Condition.IntBitsAnySet(mask));
}
...
export function xCMBuilderContains<K extends any>(this_: CMBuilder<K, string>, value: string): Condition<K> {
    return this_.mapCondition(new Condition.StringContains(value, true));
}
//! Declares com.lightningkite.lightningdb.contains>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.contains.K, kotlin.String
export function xCMBuilderContainsCased<K extends any>(this_: CMBuilder<K, string>, value: string, ignoreCase: boolean): Condition<K> {
    return this_.mapCondition(new Condition.StringContains(value, ignoreCase));
}
...
export function xCMBuilderFullTextSearch<K extends any, V extends any>(this_: CMBuilder<K, V>, value: string, ignoreCase: boolean): Condition<K> {
    return this_.mapCondition(new Condition.FullTextSearch<V>(value, ignoreCase));
}
...
export function xCMBuilderListAll<K extends any, T extends any>(this_: CMBuilder<K, Array<T>>, condition: ((a: DataClassPath<T, T>) => Condition<T>)): Condition<K> {
    return this_.mapCondition(new Condition.ListAllElements<T>((condition)(path<T>())));
}
...
export function xCMBuilderListAny<K extends any, T extends any>(this_: CMBuilder<K, Array<T>>, condition: ((a: DataClassPath<T, T>) => Condition<T>)): Condition<K> {
    return this_.mapCondition(new Condition.ListAnyElements<T>((condition)(path<T>())));
}
...
export function xCMBuilderListSizedEqual<K extends any, T extends any>(this_: CMBuilder<K, Array<T>>, count: number): Condition<K> {
    return this_.mapCondition(new Condition.ListSizesEquals<T>(count));
}
...
export function xCMBuilderSetAll<K extends any, T extends any>(this_: CMBuilder<K, Set<T>>, condition: ((a: DataClassPath<T, T>) => Condition<T>)): Condition<K> {
    return this_.mapCondition(new Condition.SetAllElements<T>((condition)(path<T>())));
}
...
export function xCMBuilderSetAny<K extends any, T extends any>(this_: CMBuilder<K, Set<T>>, condition: ((a: DataClassPath<T, T>) => Condition<T>)): Condition<K> {
    return this_.mapCondition(new Condition.SetAnyElements<T>((condition)(path<T>())));
}
...
export function xCMBuilderSetSizedEqual<K extends any, T extends any>(this_: CMBuilder<K, Set<T>>, count: number): Condition<K> {
    return this_.mapCondition(new Condition.SetSizesEquals<T>(count));
}
...
export function xCMBuilderContainsKey<K extends any, T extends any>(this_: CMBuilder<K, Map<string, T>>, key: string): Condition<K> {
    return this_.mapCondition(new Condition.Exists<T>(key));
}
...
export function xCMBuilderCondition<K extends any, T extends any>(this_: CMBuilder<K, T>, make: ((a: DataClassPath<T, T>) => Condition<T>)): Condition<K> {
    return this_.mapCondition(make(path<T>()));
}
...
export function xCMBuilderNotNullGet<K extends any, T extends any>(this_: CMBuilder<K, (T | null)>): CMBuilder<K, T> { return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.IfNotNull<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.IfNotNull<T>(it)))); }
...
export function xCMBuilderGet<K extends any, T extends any>(this_: CMBuilder<K, Map<string, T>>, key: string): CMBuilder<K, T> {
    return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.OnKey<T>(key, it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.ModifyByKey<T>(new Map([[key, it]])))));
}

//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.all.K, kotlin.collections.Listcom.lightningkite.lightningdb.all.T
export function xCMBuilderListAllGet<K extends any, T extends any>(this_: CMBuilder<K, Array<T>>): CMBuilder<K, T> { return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.ListAllElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.ListPerElement<T>(new Condition.Always<T>(), it)))); }


//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.all.K, kotlin.collections.Setcom.lightningkite.lightningdb.all.T
export function xCMBuilderSetAllGet<K extends any, T extends any>(this_: CMBuilder<K, Set<T>>): CMBuilder<K, T> { return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.SetAllElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.SetPerElement<T>(new Condition.Always<T>(), it)))); }


//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.any.K, kotlin.collections.Listcom.lightningkite.lightningdb.any.T
export function xCMBuilderListAnyGet<K extends any, T extends any>(this_: CMBuilder<K, Array<T>>): CMBuilder<K, T> { return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.ListAnyElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.ListPerElement<T>(new Condition.Always<T>(), it)))); }


//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.CMBuildercom.lightningkite.lightningdb.any.K, kotlin.collections.Setcom.lightningkite.lightningdb.any.T
export function xCMBuilderSetAnyGet<K extends any, T extends any>(this_: CMBuilder<K, Set<T>>): CMBuilder<K, T> { return new CMBuilder<K, T>((it: Condition<T>): Condition<K> => (this_.mapCondition(new Condition.SetAnyElements<T>(it))), (it: Modification<T>): Modification<K> => (this_.mapModification(new Modification.SetPerElement<T>(new Condition.Always<T>(), it)))); }

...
export declare namespace LiveFullReadModelApi {
    class Companion {
        ...
        create<Model extends HasId<string>>(Model: Array<any>, root: string, multiplexSocketUrl: string, path: string, token: string, headers?: Map<string, string>): LiveFullReadModelApi<Model>;
    }
}

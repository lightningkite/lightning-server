...
(function (Modification) {
    ...
    class OnField extends Modification {
        ...
        static propertyTypes(K, V) { return { key: [DataClassProperty_1.DataClassProperty, K, V], modification: [Modification, V] }; }
        invoke(on) {
            return this.key.set(on, this.modification.invoke(this.key.get(on)));
        }
        invokeDefault() {

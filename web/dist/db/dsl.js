...
class PropChain {
    ...
    chain(other) {
        return new PropChain((it) => (this.mapCondition(other.mapCondition(it))), (it) => (this.mapModification(other.mapModification(it))), (it) => (other.getProp(this.getProp(it))), (from, to) => (this.setProp(from, other.setProp(this.getProp(from), to))));
    }
...
function xPropChainAlwaysGet(this_) {
...
function xPropChainNeverGet(this_) {
...
function xPropChainNotInSet(this_, values) {
    return this_.mapCondition(new Condition_1.Condition.NotInside((0, iter_tools_es_1.toArray)(values)));
}
exports.xPropChainNotInSet = xPropChainNotInSet;
//! Declares com.lightningkite.lightningdb.notIn>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.notIn.K, com.lightningkite.lightningdb.notIn.T
...
function xPropChainNotNullGet(this_) {
    return new PropChain((it) => (this_.mapCondition(new Condition_1.Condition.IfNotNull(it))), (it) => (this_.mapModification(new Modification_1.Modification.IfNotNull(it))), (it) => (this_.getProp(it)), (it, value) => (this_.setProp(it, value)));
}
...
//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.all.K, kotlin.collections.Listcom.lightningkite.lightningdb.all.T
function xPropChainListAllGet(this_) {
    return new PropChain((it) => (this_.mapCondition(new Condition_1.Condition.ListAllElements(it))), (it) => (this_.mapModification(new Modification_1.Modification.ListPerElement(new Condition_1.Condition.Always(), it))), (it) => ((0, iter_tools_es_1.first)(this_.getProp(it))), (from, to) => (this_.setProp(from, this_.getProp(from).concat([to]))));
}
exports.xPropChainListAllGet = xPropChainListAllGet;
//! Declares com.lightningkite.lightningdb.all>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.all.K, kotlin.collections.Setcom.lightningkite.lightningdb.all.T
function xPropChainSetAllGet(this_) {
    return new PropChain((it) => (this_.mapCondition(new Condition_1.Condition.SetAllElements(it))), (it) => (this_.mapModification(new Modification_1.Modification.SetPerElement(new Condition_1.Condition.Always(), it))), (it) => ((0, iter_tools_es_1.first)(this_.getProp(it))), (from, to) => (this_.setProp(from, new khrysalis_runtime_1.EqualOverrideSet([...this_.getProp(from), to]))));
}
exports.xPropChainSetAllGet = xPropChainSetAllGet;
//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.any.K, kotlin.collections.Listcom.lightningkite.lightningdb.any.T
function xPropChainListAnyGet(this_) {
    return new PropChain((it) => (this_.mapCondition(new Condition_1.Condition.ListAnyElements(it))), (it) => (this_.mapModification(new Modification_1.Modification.ListPerElement(new Condition_1.Condition.Always(), it))), (it) => ((0, iter_tools_es_1.first)(this_.getProp(it))), (from, to) => (this_.setProp(from, this_.getProp(from).concat([to]))));
}
exports.xPropChainListAnyGet = xPropChainListAnyGet;
//! Declares com.lightningkite.lightningdb.any>com.lightningkite.lightningdb.PropChaincom.lightningkite.lightningdb.any.K, kotlin.collections.Setcom.lightningkite.lightningdb.any.T
function xPropChainSetAnyGet(this_) {
    return new PropChain((it) => (this_.mapCondition(new Condition_1.Condition.SetAnyElements(it))), (it) => (this_.mapModification(new Modification_1.Modification.SetPerElement(new Condition_1.Condition.Always(), it))), (it) => ((0, iter_tools_es_1.first)(this_.getProp(it))), (from, to) => (this_.setProp(from, new khrysalis_runtime_1.EqualOverrideSet([...this_.getProp(from), to]))));
}

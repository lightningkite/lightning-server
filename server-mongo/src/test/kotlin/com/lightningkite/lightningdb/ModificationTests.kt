...
class ModificationTests : MongoTest() {
    ...
    @Test fun test_Set_push() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_push")
    ...
    @Test fun test_Set_pull() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_pull")
        val item = LargeTestModel(set = setOf(1, 2, 3))
        collection.insertOne(item)
    ...
    @Test fun test_Set_pull_embedded() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("test_Set_pull_embedded")
    ...
    @Test fun test_Set_pullAll() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_pullAll")
        val item = LargeTestModel(set = setOf(1, 2, 3))
        collection.insertOne(item)
    ...
    @Test fun test_Set_popFirst()  = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_popFirst")
        val item = LargeTestModel(set = setOf(1, 2, 3))
        collection.insertOne(item)
    ...
    @Test fun test_Set_popLast() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_popLast")
        val item = LargeTestModel(set = setOf(1, 2, 3))
        collection.insertOne(item)
    ...
    @Test fun test_Set_matching() = runBlocking {
        val collection = defaultMongo.collection<LargeTestModel>("LargeTestModel_test_Set_matching")
        val item = LargeTestModel(set = setOf(1, 2, 3))
        collection.insertOne(item)

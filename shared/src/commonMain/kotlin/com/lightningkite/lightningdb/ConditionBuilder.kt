...
fun <K, V> DataClassPath<K, V>.fullTextSearch(value: String, ignoreCase: Boolean, threshold: Double? = null) = mapCondition(Condition.FullTextSearch<V>(value, ignoreCase = ignoreCase, threshold = threshold))

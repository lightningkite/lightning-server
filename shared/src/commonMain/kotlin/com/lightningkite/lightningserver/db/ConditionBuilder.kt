...
fun <K, V> DataClassPath<K, V>.fullTextSearch(value: String, levenshteinDistance: Int = 2, requireAllTermsPresent: Boolean = true, ) = mapCondition(Condition.FullTextSearch<V>(value, requireAllTermsPresent = requireAllTermsPresent, levenshteinDistance = levenshteinDistance,))
...
@Deprecated("Use neq instead", ReplaceWith("this.neq(value)", "com.lightningkite.lightningserver.db.neq"))
...
@Deprecated("Use notInside instead", ReplaceWith("this.notInside(value)", "com.lightningkite.lightningserver.db.notInside"))
...
@Deprecated("Use notInside instead", ReplaceWith("this.notInside(values)", "com.lightningkite.lightningserver.db.notInside"))

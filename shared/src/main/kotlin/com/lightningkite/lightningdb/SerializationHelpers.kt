...
class KSerializerKey(val kSerializer: KSerializer<*>) {
    val hashCode = kSerializer.descriptor.contentHashCode()
    override fun hashCode(): Int = hashCode

    override fun equals(other: Any?): Boolean =
        other is KSerializerKey && this.hashCode == other.hashCode && this.kSerializer.descriptor matches other.kSerializer.descriptor

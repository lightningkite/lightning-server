...
fun <T> Modification<T>.matchesPath(modification: Modification<T>): Boolean {
    return when(this) {
        ...
        is Modification.IfNotNull<*> -> {
            @Suppress("UNCHECKED_CAST")
            (this.modification as Modification<Any?>).matchesPath((modification as? Modification.IfNotNull<Any?>)?.modification ?: modification as Modification<Any?>)
        }
        else -> true
    }
}
fun <T> Condition<T>.matchesPath(modification: Modification<T>): Boolean {
    return when(this) {
        ...
        is Condition.ListAllElements<*> -> @Suppress("UNCHECKED_CAST") (this.condition as Condition<Any?>).matchesPath((modification as? Modification.ListPerElement<*>)?.modification as? Modification<Any?> ?: return false)
        is Condition.ListAnyElements<*> -> @Suppress("UNCHECKED_CAST") (this.condition as Condition<Any?>).matchesPath((modification as? Modification.ListPerElement<*>)?.modification as? Modification<Any?> ?: return false)
        is Condition.SetAllElements<*> -> @Suppress("UNCHECKED_CAST") (this.condition as Condition<Any?>).matchesPath((modification as? Modification.ListPerElement<*>)?.modification as? Modification<Any?> ?: return false)
        is Condition.SetAnyElements<*> -> @Suppress("UNCHECKED_CAST") (this.condition as Condition<Any?>).matchesPath((modification as? Modification.ListPerElement<*>)?.modification as? Modification<Any?> ?: return false)
        ...
        is Condition.IfNotNull<*> -> {
            @Suppress("UNCHECKED_CAST")
            (this.condition as Condition<Any?>).matchesPath((modification as? Modification.IfNotNull<Any?>)?.modification ?: modification as Modification<Any?>)
        }
        else -> true
    }
}

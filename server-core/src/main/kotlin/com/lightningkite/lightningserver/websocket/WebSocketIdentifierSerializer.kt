...
object WebSocketIdentifierSerializer : KSerializer<WebSocketIdentifier> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("com.lightningkite.lightningserver.websocket.WebSocketIdentifier", PrimitiveKind.STRING)

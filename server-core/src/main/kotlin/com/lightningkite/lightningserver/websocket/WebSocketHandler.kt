...
sealed interface WebSocketFrame {
    ...
    @JvmInline value class Text(override val content: String) : WebSocketFrame {
        override fun toString(): String = content
    }
    @JvmInline value class Binary(override val content: ByteArray) : WebSocketFrame {
        @OptIn(ExperimentalStdlibApi::class)
        override fun toString(): String = "<bytes ${content.toHexString()}>"
    }
}
val WebSocketFrame.text: String get() = when (this) {

...
class AnonType {
    ...
    override fun hashCode(): Int =
        if (hasDirect) direct.hashCode() else serializedBytes?.contentHashCode() ?: serializedString?.hashCode() ?: 0
...
object ByteArrayAnonTypeSerializer : KSerializer<AnonType> {
    override val descriptor: SerialDescriptor =
        SerialDescriptor("com.lightningkite.lightningserver.serialization.AnonType", ByteArraySerializer().descriptor)
...
object StringAnonTypeSerializer : KSerializer<AnonType> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("com.lightningkite.lightningserver.serialization.AnonType", PrimitiveKind.STRING)
